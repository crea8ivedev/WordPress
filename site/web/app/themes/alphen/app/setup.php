...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_localize_script('sage/vendor.js', 'ajax_object', $ajax_params);
...
add_action('after_setup_theme', function () {
    ...
    register_nav_menus([
        ...
        'inner_navigation' => __('Inner Navigation', 'sage'),
        ...
        'footer_navigation_5' => __('Footer Navigation 5', 'sage'),
        'footer_navigation_6' => __('Footer Navigation 6', 'sage'),
    ]);
