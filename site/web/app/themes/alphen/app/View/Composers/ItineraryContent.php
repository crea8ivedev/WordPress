...
class ItineraryContent extends Composer
{
    ...
    protected static $views = [
        'partials.content-single-itinerary',
    ];
    ...
    {
        return [
            'itineraryContetData' => $this->itineraryContetData(),
        ];
    }

    public function itineraryContetData()
    {
        $data = [];
        $flexible_content = get_field('itinerary_content');
        if($flexible_content){
            foreach($flexible_content as $content) {
                ...
                else if($content['acf_fc_layout']=='gallery_content'){
                    $this_content = (object) [
                        'layout' => $content['acf_fc_layout'],
                        'image' => $content['image'],
                        'image_position' => $content['image_position'],
                ...
                else if($content['acf_fc_layout']=='cta_box'){
                    $this_content = (object) [
                        'layout' => $content['acf_fc_layout'],
                        'heading' => $content['heading'],
                        'description' => $content['description'],
