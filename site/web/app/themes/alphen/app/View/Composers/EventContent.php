...
class EventContent extends Composer
{
    ...
    protected static $views = [
        'partials.content-single-special_event',
    ];
    ...
    {
        return [
            'eventContetData' => $this->eventContetData(),
        ];
    }

    public function eventContetData()
    {
        $data = [];
        $flexible_content = get_field('event_content');
        if($flexible_content){
            foreach($flexible_content as $content) {
                ...
                else if($content['acf_fc_layout']=='other_event'){

                    $event_final_array = array();
                    $event_args = array(
