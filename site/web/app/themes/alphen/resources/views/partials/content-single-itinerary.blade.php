@if($itineraryContetData)
	
	@foreach($itineraryContetData as $content)
		...
		@elseif($content->layout == 'gallery_content')
			@include('partials.sections.gallery_content')
		
		@elseif($content->layout == 'cta_box')
			@include('partials.sections.cta_box')
