...
<?php
    $image_size = 'portrait';
    if(isset($content->image_size) && $content->image_size) {
...
?>
<section class="zigzag lg:pt-150 pt-50 img-{{ $image_size }} {!! $content->extra_class !!}" @if($content->id) id="{{ $content->id }}" @endif>
    <div class="container">
        <div class="zigzag-inner flex flex-wrap items-center">
            <div class="{!! $left_col !!} w-full @if($content->image_position == 'right') lg:order-2 @endif">
                <div class="zigzag-image lg:pt-0 lg:pb-0 mb-20 wow fadeInUp" data-wow-delay="0.2s">
                    <img data-src="{!! $content->image['url'] !!}" alt="{!! $content->image['title'] !!}" class="lozad w-full">
                </div>
            </div>
            <div class="{!! $right_col !!} w-full @if($content->image_position == 'right') lg:order-1 @endif">
                <div class="zigzag-content @if($content->image_position == 'right') lg:pr-120 md:pr-60 lg:pl-50 @else lg:pl-120 lg:pr-50 @endif">
                    ...
                    <div class="btn-group flex flex-col">
                        ...
                        <div class="link wow fadeInUp pt-10 inline-block opacity-40" data-wow-delay="0.8s">
